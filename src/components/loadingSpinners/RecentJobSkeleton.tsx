  ...
  return (
    <div>
      <div className="flex items-end justify-between mb-6">
        <div>
          <div className="h-8 w-72 max-w-full rounded bg-gray-200 animate-pulse" />
          <div className="h-4 w-64 max-w-full rounded bg-gray-100 animate-pulse mt-3" />
        </div>
        <div className="h-4 w-16 rounded bg-gray-100 animate-pulse shrink-0" />
      </div>
