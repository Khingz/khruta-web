...
export const HeroSection = () => {
  return (
    <div>
      <div
        className="absolute inset-0 -z-10 opacity-[0.04] animate-fade-in-up"
        style={{
          backgroundImage:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 pb-12 sm:pt-24 sm:pb-20 text-center">
        <h1 className="font-display text-4xl sm:text-6xl font-bold text-[#1F2937] tracking-tight leading-[1.05] animate-fade-in-up">
          The premium way to <br className="hidden sm:block" />
          <span className="gradient-text">land your next role.</span>
        </h1>
        <p className="mt-5 text-lg text-[#6B7280] max-w-2xl mx-auto animate-fade-in-up [animation-delay:150ms] opacity-0">
          Khruta brings every step of your job search into one calm, beautifully designed workspace.
          From discovery to offer.
        </p>
        <div className="mt-8 max-w-3xl mx-auto animate-fade-in-up [animation-delay:300ms] opacity-0">
          <SearchBar />
        </div>
        <p className="mt-4 text-sm text-[#6B7280] animate-fade-in-up [animation-delay:450ms] opacity-0">
          Popular:{" "}
          <Link
            to="/jobs"
